...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 1. This is a summary of maximum and minimum number of horse for each province.")
```

Below we zoom in and look at the province of `r max_horses$Province[1]` :

```{r plot province, fig.width=5, fig.height=4, fig.cap = "The historical numbe of horse for province of focus", out.width = '40%'}
